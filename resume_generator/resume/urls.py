...
from resume_generator.settings import EMAIL_HOST_USER
...
urlpatterns = [
    ...
    path('reset_password/',auth_views.PasswordResetView.as_view(template_name='user/password_reset_form.html',from_email=EMAIL_HOST_USER),name='password_reset'),
    ...
    path('resume/<int:resume_id>',views.view_resume,name='resumeView'),
    path('generate_pdf/<int:resume_id>/<str:pdf_rendering>/', views.GeneratePdf.as_view(), name='generate_pdf'),
